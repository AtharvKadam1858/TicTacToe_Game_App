...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void endGame () {
        ...
        if(a.equals("X") && b.equals("X") && c.equals("X")) {
            Toast.makeText(MainActivity2.this, "Winner Player X!", Toast.LENGTH_LONG).show();
            end = true;
        ...
        if(a.equals("O") && b.equals("O") && c.equals("O")) {
            Toast.makeText(MainActivity2.this, "Winner Player O!", Toast.LENGTH_LONG).show();
            end = true;
        }
        ...
        if (draw == 9 && !end ) {
            Toast.makeText(MainActivity2.this, "Draw Game!", Toast.LENGTH_LONG).show();
            playAgain.setVisibility(View.VISIBLE);
        }
    }
